        ...
        return (
            <form onSubmit={this.onFormSubmit} noValidate autoComplete="off">
                <Paper className={classes.root} elevation={1}>
                    ...
                    <InputBase className={classes.input} placeholder="Search Todos" value={searchText} onChange={event => this.props.setSearchText(event.target.value)} />
...
export default connect(mapStateToProps, {setSearchText})(TodosSearchBoxStyled);
